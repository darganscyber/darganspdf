  ...
  en: {
    translation: {
      ...
      home: {
        ...
        subtitle: "20 powerful tools to edit, convert, and secure your PDF.",
  ...
  tr: {
    translation: {
      ...
      home: {
        ...
        title2: "PDF Araçları.",
        subtitle: "PDF'nizi düzenlemek, dönüştürmek ve güvenceye almak için 20 güçlü araç.",
  ...
  de: {
    translation: {
      ...
      home: {
        ...
        subtitle: "20 leistungsstarke Tools, um Ihre PDF zu bearbeiten, zu konvertieren und zu sichern.",
  ...
  ja: {
    translation: {
      ...
      home: {
        ...
        title1: "本当に役立つ",
        title2: "PDFツール。",
        subtitle: "PDFを編集、変換、保護するための20の強力なツール。",
        cta1: "無料でお試し — 登録不要",
        cta2: "デモを見る",
  ...
  es: {
    translation: {
      ...
      home: {
        ...
        subtitle: "20 herramientas poderosas para editar, convertir y asegurar su PDF.",
  ...
  it: {
    translation: {
      ...
      home: {
        ...
        subtitle: "20 potenti strumenti per modificare, convertire e proteggere i tuoi PDF.",
  ...
  ru: {
    translation: {
      ...
      home: {
        ...
        subtitle: "20 мощных инструментов для редактирования, конвертации и защиты PDF.",
  ...
  fr: {
    translation: {
      ...
      home: {
        ...
        subtitle: "20 outils puissants pour éditer, convertir et sécuriser votre PDF.",
